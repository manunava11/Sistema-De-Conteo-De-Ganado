...
model = YOLO(os.path.join(output_folder, r'C:\Users\Manuel\Desktop\Carpeta Visual\Sistema-De-Conteo-De-Ganado\EntrenarYolov8\Yolov8m200Epochs.pt')).to(device)
...
while cap.isOpened():
    ...
    tracks = model.track(im0, persist=True, show=False, conf=0.6,iou=0.4, tracker="bytetrack.yaml")
