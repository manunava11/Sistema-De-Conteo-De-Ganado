...
Original file is located at
    https://colab.research.google.com/drive/1Zue_GELhwvn5pwBn1a77dVMCcyYvjMsg
...
rf = Roboflow(api_key="6wahoxyG73VyhBtLX7NN")
project = rf.workspace("manunava11").project("cows-o8e9i")
